 ...
 * @ENTRY_COL_CRE_USER       : creation user                      String       Yes
 * @ENTRY_COL_CRE_STAMP      : creation timestamp                 String       Yes
 ...
 * @ENTRY_COL_IPERIOD        : period indicator localized string  String       Yes
 * @ENTRY_COL_IPERIOD_I      : period indicator                   Int           No

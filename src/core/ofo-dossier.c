...
dbmodel_to_v1( ofoSgbd *sgbd, const gchar *name, const gchar *account )
{
	...
	if( !ofo_sgbd_query( sgbd,
			...
			"	ECR_RAPPRO_DVAL  DATE                     COMMENT 'Reconciliation value date',"
			"	ECR_RAPPRO_USER  VARCHAR(20)              COMMENT 'User responsible of the reconciliation',"
			"	ECR_RAPPRO_STAMP TIMESTAMP                COMMENT 'Reconciliation timestamp',"

...
#ifndef __OFO_ENTRY_FEC_H__
#define __OFO_ENTRY_FEC_H__
...
ofsIExporterFormat *ofo_entry_fec_get_exporter_formats( ofaIExporter *exporter,
															GType exportable_type,
															ofaIGetter *getter );

gboolean            ofo_entry_fec_export              ( ofaIExportable *exportable );

G_END_DECLS

#endif /* __OFO_ENTRY_FEC_H__ */

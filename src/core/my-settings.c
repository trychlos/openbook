...
/**
 * my_settings_remove_group:
 * @settings: this #mySettings instance.
 * @group: the group name in the @settings file.
 *
 * Remove the @group from the @settings file.
 */
void
my_settings_remove_group( mySettings *settings, const gchar *group )
{
	mySettingsPrivate *priv;
...
/**
 * my_settings_get_keys:
 * @settings: this #mySettings instance.
 * @group: the group name in the @settings file.
 *
 * Returns: the list of keys defined in the @group, as a #GList which
 * should be #my_settings_free_keys() by the caller.
 */
GList *
my_settings_get_keys( const mySettings *settings, const gchar *group )
{
	mySettingsPrivate *priv;
	gchar **array, **iter;
	GList *list;
 ...
 */
void
my_settings_remove_key( mySettings *settings, const gchar *group, const gchar *key )
{
	mySettingsPrivate *priv;

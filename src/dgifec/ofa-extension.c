...
{
	static const gchar *thisfn = "dgifec/ofa_extension_startup";
...
{
	static const gchar *thisfn = "dgifec/ofa_extension_enum_types";

	g_debug( "%s: module=%p, cb=%p, user_data=%p",
			thisfn, ( void * ) module, ( void * ) cb, ( void * ) user_data );

	cb( OFA_TYPE_FEC_IDENT, user_data );
}
...
{
	static const gchar *thisfn = "dgifec/ofa_extension_shutdown";
...
{
	static const gchar *thisfn = "dgifec/ofa_extension_get_version_number";

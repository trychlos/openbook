...
{
	static const gchar *thisfn = "import-lcl-pdf/ofa_module_ofa_extension_startup";

	g_debug( "%s: module=%p", thisfn, ( void * ) module );

	ofa_lcl_pdf_importer_register_type( module );
...
{
	static const gchar *thisfn = "import-lcl-pdf/ofa_module_ofa_extension_list_types";
	static GType types_list [1+TYPES_COUNT];

	g_debug( "%s: types=%p", thisfn, ( void * ) types );

	types_list[0] = OFA_TYPE_LCL_PDF_IMPORTER;
...
{
	static const gchar *thisfn = "import-lcl-pdf/ofa_module_ofa_extension_shutdown";

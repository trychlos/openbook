 ...
 *                                                          Type     Displayable
 *                                                          -------  -----------
 * @PER_COL_CODE          : identifier                       String       Yes
 * @PER_COL_LABEL         : label                            String       Yes
 * @PER_COL_HAVE_DETAIL   : whether it has details           String       Yes
 * @PER_COL_HAVE_DETAIL_B : whether it has details           Boolean       No

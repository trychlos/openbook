 ...
 */
guint
my_iassistant_get_interface_version( const myIAssistant *instance )
{
	static const gchar *thisfn = "my_iassistant_get_interface_version";

	g_debug( "%s: instance=%p", thisfn, ( void * ) instance );

	g_return_val_if_fail( instance && MY_IS_IASSISTANT( instance ), 0 );

	if( MY_IASSISTANT_GET_INTERFACE( instance )->get_interface_version ){

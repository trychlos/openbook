...
#ifndef __OFA_MISC_CHKENTBAL_H__
#define __OFA_MISC_CHKENTBAL_H__
...
gboolean ofa_misc_chkentbal_run( ofoDossier *dossier, myProgressBar *bar, ofaBalancesGrid *grid );

G_END_DECLS

#endif /* __OFA_MISC_CHKENTBAL_H__ */

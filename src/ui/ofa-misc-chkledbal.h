...
#ifndef __OFA_MISC_CHKLEDBAL_H__
#define __OFA_MISC_CHKLEDBAL_H__
 ...
 *
 * Check that the ledgers on the current exercice are balanced.
 *
...
gboolean ofa_misc_chkledbal_run( ofoDossier *dossier, myProgressBar *bar, ofaBalancesGrid *grid );

G_END_DECLS

#endif /* __OFA_MISC_CHKLEDBAL_H__ */

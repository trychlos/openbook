 ...
 * ofsExportSettings:
 *
 * The parameters which are of used when exporting.
 */
typedef struct {
	gchar *charmap;
	gint   date_format;
...
ofaExportSettings *ofa_export_settings_new          ( void );

void               ofa_export_settings_attach_to    ( ofaExportSettings *settings,
															GtkContainer *parent );

void               ofa_export_settings_init_dlg     ( ofaExportSettings *settings );

gboolean           ofa_export_settings_apply        ( ofaExportSettings *settings );

ofsExportSettings *ofa_export_settings_get_settings ( const gchar *name );

void               ofa_export_settings_free_settings( ofsExportSettings *settings );

...
static const gchar *st_resource_ui      = "/org/trychlos/openbook/ui/ofa-bat-line-properties.ui";
...
G_DEFINE_TYPE_EXTENDED( ofaBatLineProperties, ofa_bat_line_properties, GTK_TYPE_DIALOG, 0,
		G_ADD_PRIVATE( ofaBatLineProperties )
		G_IMPLEMENT_INTERFACE( MY_TYPE_IWINDOW, iwindow_iface_init )
		G_IMPLEMENT_INTERFACE( MY_TYPE_IDIALOG, idialog_iface_init ))

static void
bat_line_properties_finalize( GObject *instance )
{
	static const gchar *thisfn = "ofa_bat_line_properties_finalize";

	g_debug( "%s: instance=%p (%s)",
			thisfn, ( void * ) instance, G_OBJECT_TYPE_NAME( instance ));

	g_return_if_fail( instance && OFA_IS_BAT_LINE_PROPERTIES( instance ));

	/* free data members here */

	/* chain up to the parent class */
	G_OBJECT_CLASS( ofa_bat_line_properties_parent_class )->finalize( instance );
}

static void
bat_line_properties_dispose( GObject *instance )
{
	ofaBatLinePropertiesPrivate *priv;

	g_return_if_fail( instance && OFA_IS_BAT_LINE_PROPERTIES( instance ));

	priv = ofa_bat_line_properties_get_instance_private( OFA_BAT_LINE_PROPERTIES( instance ));
	...
	/* chain up to the parent class */
	G_OBJECT_CLASS( ofa_bat_line_properties_parent_class )->dispose( instance );
}

static void
ofa_bat_line_properties_init( ofaBatLineProperties *self )
{
	static const gchar *thisfn = "ofa_bat_line_properties_init";
	ofaBatLinePropertiesPrivate *priv;

	g_debug( "%s: self=%p (%s)",
			thisfn, ( void * ) self, G_OBJECT_TYPE_NAME( self ));

	g_return_if_fail( self && OFA_IS_BAT_LINE_PROPERTIES( self ));

	priv = ofa_bat_line_properties_get_instance_private( self );
...
static void
ofa_bat_line_properties_class_init( ofaBatLinePropertiesClass *klass )
{
	static const gchar *thisfn = "ofa_bat_line_properties_class_init";

	g_debug( "%s: klass=%p", thisfn, ( void * ) klass );

	G_OBJECT_CLASS( klass )->dispose = bat_line_properties_dispose;
	G_OBJECT_CLASS( klass )->finalize = bat_line_properties_finalize;

	gtk_widget_class_set_template_from_resource( GTK_WIDGET_CLASS( klass ), st_resource_ui );
}

/**
 * ofa_bat_line_properties_run:
 ...
 */
void
ofa_bat_line_properties_run( ofaIGetter *getter, GtkWindow *parent, ofoBatLine *batline )
{
	static const gchar *thisfn = "ofa_bat_line_properties_run";
	...
	self = g_object_new( OFA_TYPE_BAT_LINE_PROPERTIES, NULL );
...
{
	static const gchar *thisfn = "ofa_bat_line_properties_iwindow_iface_init";
...
{
	static const gchar *thisfn = "ofa_bat_line_properties_iwindow_init";
	ofaBatLinePropertiesPrivate *priv;
...
{
	static const gchar *thisfn = "ofa_bat_line_properties_idialog_iface_init";
...
{
	static const gchar *thisfn = "ofa_bat_line_properties_idialog_init";
	ofaBatLinePropertiesPrivate *priv;
	...
	setup_ui_properties( OFA_BAT_LINE_PROPERTIES( instance ));
	setup_data( OFA_BAT_LINE_PROPERTIES( instance ));
	...
	check_for_enable_dlg( OFA_BAT_LINE_PROPERTIES( instance ));
}

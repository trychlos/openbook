...
GList          *ofo_ledger_get_arc_orphans         ( ofaIGetter *getter );
#define         ofo_ledger_free_arc_orphans( L )   ( g_list_free_full(( L ), ( GDestroyNotify ) g_free ))

GList          *ofo_ledger_get_cur_orphans         ( ofaIGetter *getter );
#define         ofo_ledger_free_cur_orphans( L )   ( g_list_free_full(( L ), ( GDestroyNotify ) g_free ))

GList          *ofo_ledger_get_doc_orphans         ( ofaIGetter *getter );
#define         ofo_ledger_free_doc_orphans( L )   ( g_list_free_full(( L ), ( GDestroyNotify ) g_free ))

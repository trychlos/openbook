...
#ifndef __OPENBOOK_API_OFA_IDBEXERCICE_EDITOR_DEF_H__
#define __OPENBOOK_API_OFA_IDBEXERCICE_EDITOR_DEF_H__
...
#endif /* __OPENBOOK_API_OFA_IDBEXERCICE_EDITOR_DEF_H__ */

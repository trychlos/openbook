...
{
	static const gchar *thisfn = "of2_module_ofa_extension_startup";
...
{
	static const gchar *thisfn = "of2_module_ofa_extension_get_api_version";
	guint version;
...
{
	static const gchar *thisfn = "of2_module_ofa_extension_list_types";
...
{
	static const gchar *thisfn = "of2_module_ofa_extension_shutdown";

...
#include "import1/of2-importer.h"
...
{
	static const gchar *thisfn = "import2/of2_module_ofa_extension_startup";

	g_debug( "%s: module=%p", thisfn, ( void * ) module );

	of2_importer_register_type( module );
...
{
	static const gchar *thisfn = "import2/of2_module_ofa_extension_get_api_version";
	guint version;
...
{
	static const gchar *thisfn = "import2/of2_module_ofa_extension_list_types";
	static GType types_list [1+OFA_TYPES_COUNT];

	g_debug( "%s: types=%p", thisfn, ( void * ) types );

	types_list[0] = OF2_TYPE_IMPORTER;
...
{
	static const gchar *thisfn = "import2/of2_module_ofa_extension_shutdown";

...
{
	static const gchar *thisfn = "importers/ofa_module_ofa_extension_startup";

	g_debug( "%s: module=%p, getter=%p", thisfn, ( void * ) module, ( void * ) getter  );

	ofa_import_csv_register_type( module );
...
{
	static const gchar *thisfn = "importers/ofa_module_ofa_extension_list_types";
	static GType types_list [1+TYPES_COUNT];
	gint i = 0;

	g_debug( "%s: types=%p", thisfn, ( void * ) types );

	types_list[i++] = OFA_TYPE_IMPORT_CSV;
...
{
	static const gchar *thisfn = "importers/ofa_module_ofa_extension_shutdown";

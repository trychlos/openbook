...
{
	static const gchar *thisfn = "import-lcl/ofa_module_ofa_extension_startup";

	g_debug( "%s: module=%p, application=%p", thisfn, ( void * ) module, ( void * ) application  );

	ofa_lcl_importer_register_type( module );
...
{
	static const gchar *thisfn = "import-lcl/ofa_module_ofa_extension_get_api_version";
	guint version;
...
{
	return( "LCL tabulated BAT Importer #1" );
}
...
{
	static const gchar *thisfn = "import-lcl/ofa_module_ofa_extension_list_types";
	static GType types_list [1+TYPES_COUNT];

	g_debug( "%s: types=%p", thisfn, ( void * ) types );

	types_list[0] = OFA_TYPE_LCL_IMPORTER;
...
{
	static const gchar *thisfn = "import-lcl/ofa_module_ofa_extension_shutdown";
